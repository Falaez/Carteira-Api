...
class TransacaoServiceTest {
	...
	@BeforeEach
	public void before() {
		this.logado = new Usuario("Mario","mario@email.com","123456");
	}
	...
	void deveriaCadastrarUmaTransacao() {
		...
		Transacao transacao = new Transacao(formDto.getTicker(), formDto.getPreco(), 
				formDto.getQuantidade(), formDto.getData(), formDto.getTipo(), logado);
		...
		Mockito.verify(transacaoRespository).save(Mockito.any());
